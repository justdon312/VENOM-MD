...
const getTime = (_0x232921, _0x3d6d6e) => {
  const _0x31b3f7 = global.timezone || "Africa/Nairobi";
  if (_0x3d6d6e) {
  ...
  try {
    ...
    wasi_bot.getpp = async (_0x577c8f = wasi_bot.user) => {
      try {
        ...
        return "https://telegra.ph/file/9047531e93cfe1a78a1f8.jpg";
      }
    };
    ...
    wasi_bot.send = async (
      _0x1def38,
      _0x1bb9da = {
        mentions: [venom_bot.user],
      },
      _0xb61629 = "venom",
      _0x919f26 = "",
      _0x3ccfb1 = venom_bot.chat
    ) => {
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("venomMD");
  ...
  _0x2d6cd0.getpp = async (_0x267509 = _0x2d6cd0.sender) => {
    try {
      ...
      return "https://telegra.ph/file/5a79f943e5ef2b69dc3cd.jpg";
    }
  };
